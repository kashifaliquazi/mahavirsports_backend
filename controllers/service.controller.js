...
serviceController.addpurchase= async (body)=>{
    try {
        console.log("serviceController.addpurchase:body ",body);
        let user = await serviceModel.addpurchase(body);
        console.log("addServiceBoy.signup:user ",user);
        // We need to send OTP to Mobile number

        return {"message":`Purchase added successfully`};
        }catch(ex){
            console.log("addServiceBoy.signup:ex ",ex);
        throw ex;
        }
}
...
// serviceController.registerEvent = async (req, res) => {
...
//   });
// }
// serviceController.getEvents = async (req, res) => {
...
//   });
// }
// serviceController.acceptEvent = async (req, res) => {
//   let event = req.body;
//   console.log("event :" +event);
//   //return event; 
//   try{
...
// serviceController.selectFauForEvent = async (req, res) => {
//   let event = req.body;
...
// serviceController.askUsersForMission = async (req, res) => {
//   try{
...
// serviceController.userAnswer = async (req, res) => {
//   let event = req.body;
//   console.log("event :" ,event);
...
// serviceController.problemWithConstraint = async (req, res) => {
//   try{
...
// serviceController.startSelectFau = async (req, res) => {
//   let event = req.body;
//   console.log("event :" ,event);
...
// serviceController.finalCallFromFAUForSelection = async (req, res) => {
//   let event = req.body;
...
// serviceController.getEventById = async (req, res) => {
//   let event = {
...
// serviceController.FAUResponseAfterReachingAccidentSite = async (req, res) => {
//   let event = req.body;
//   try{
...
// serviceController.endMissionForFAU = async (req, res) => {
//   let event = req.body;
//   try{
//     console.log("event",event);
...
// serviceController.submitWhoIsInvolvedInEvent = async (req, res) => {
// let event = req.body;
...
// serviceController.submitNotesInEvent = async (req, res) => {
//   let event = req.body;
//   try{
//     console.log("event",event);
...
// serviceController.closeEventByPSAP = async (req, res) => {
//   let event = req.body;
//   try{
...
// serviceController.arrivalOfEmergencyUnit = async (req, res) => {
//   let event = req.body;
//   try{
...
// serviceController.sendMoreFaus = async (req, res) => {
//   let event = req.body;
//   try{
...
// serviceController.getEventsForAdmin = async (req, res) => {
//   let event = { event_status: req.param('event_status'),
//   PSAP_center_id: req.param('PSAP_center_id'),
...
// serviceController.updateDisappearedUserDetails = async (req, res) => {
//   try{
...
// serviceController.selectUserForDisappearance = async (req, res) => {
//   let event = req.body;
//   try{
//     console.log("event",event);
//     let user = {
...
// serviceController.sendMessageToUsersinVicinity = async (req, res) => {
//   let event = req.body;
//   try{
...
// serviceController.cancelResearchForDisappearance = async (req, res) => {
//   let event = req.body;
//   try{
...
// serviceController.userAcknowledgedForDisappearance = async (req, res) => {
//   let event = req.body;
...
// serviceController.closeDisappearedEvent = async (req, res) => {
//   let event = req.body;
...
// serviceController.changeVicinityArea = async (req, res) => {
//   let event = req.body;
...
// serviceController.pauseOrResumeLocationUpdates = async (req, res) => {
//   let event = req.body;
...
// serviceController.getSecuredURLToUploadAudio = async (req, res) => {
//   let event = req.body;
//   console.log(" inside event :" ,event);
//   try{
...
// serviceController.getEventsBasedOnIds = async (req, res) => {
...
// serviceController.getDisappearedUserRecordings = async (req, res) => {
//   let event = {
//      event_id: req.param("event_id"),
...
// serviceController.getTwilioAccessTokenForVideoCall = async (req, res) => {
//   let event = req.body;
//   try{
...
// serviceController.rejectVideoCall = async (req, res) => {
//   let event = req.body;
//   try{
...
// serviceController.getAssignedPSAPCenterByEventId = async (req, res) => {
//   let event = {
//     event_id:req.param("event_id")
//   };
//   try{
...
// //We update the “event_status” to 172 and insert all the information related to the persons involved in event sent by the PSAP agent
// // And sends the real time message to all the Active FAUs.
// serviceController.closeFreeUserEvent = async (req, res) => {
//   let event = req.body;
//   try{
//     console.log("closeEventByPSAP params :",event);
//     let authorization = req.headers['authorization'];
...
// //We update the “event_status” to 172 and insert all the information related to the persons involved in event sent by the PSAP agent
// // And sends the real time message to all the Active FAUs.
// serviceController.cancelFAURecruitement = async (req, res) => {
//   let event = req.body;
//   try{
//     console.log("closeEventByPSAP params :",event);
//     let authorization = req.headers['authorization'];
...
//   });
// }
// serviceController.closeFreeEventsWithBatch = async (req, res) => {
