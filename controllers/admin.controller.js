...
adminController.getusers= async (body)=>{
    try {
        console.log("adminController.login:body ",body);
        let users = await adminModel.getusers(body);
        console.log("adminController.getusers:users ",users);
        return users;
        }catch(ex){
        throw ex;
        }
...
adminController.addServiceBoy= async (body)=>{
    try {
        console.log("adminController.login:body ",body);
        let user = await adminModel.addServiceBoy(body);
...
adminController.getPurchases= async (body)=>{
    try {
        console.log("adminController.getPurchases:body ",body);
        let purchases = await adminModel.getPurchases(body);
        return purchases;
        }catch(ex){
        throw ex;
        }
...
// adminController.registerEvent = async (req, res) => {
...
//   });
// }
// adminController.getEvents = async (req, res) => {
...
//   });
// }
// adminController.acceptEvent = async (req, res) => {
//   let event = req.body;
//   console.log("event :" +event);
//   //return event; 
//   try{
...
// adminController.selectFauForEvent = async (req, res) => {
//   let event = req.body;
...
// adminController.askUsersForMission = async (req, res) => {
//   try{
...
// adminController.userAnswer = async (req, res) => {
//   let event = req.body;
//   console.log("event :" ,event);
...
// adminController.problemWithConstraint = async (req, res) => {
//   try{
...
// adminController.startSelectFau = async (req, res) => {
//   let event = req.body;
//   console.log("event :" ,event);
...
// adminController.finalCallFromFAUForSelection = async (req, res) => {
//   let event = req.body;
...
// adminController.FAUResponseAfterReachingAccidentSite = async (req, res) => {
//   let event = req.body;
//   try{
...
// adminController.endMissionForFAU = async (req, res) => {
//   let event = req.body;
//   try{
//     console.log("event",event);
...
// adminController.submitWhoIsInvolvedInEvent = async (req, res) => {
// let event = req.body;
...
// adminController.submitNotesInEvent = async (req, res) => {
//   let event = req.body;
//   try{
//     console.log("event",event);
...
// adminController.closeEventByPSAP = async (req, res) => {
//   let event = req.body;
//   try{
...
// adminController.arrivalOfEmergencyUnit = async (req, res) => {
//   let event = req.body;
//   try{
...
// adminController.sendMoreFaus = async (req, res) => {
//   let event = req.body;
//   try{
...
// adminController.getEventsForAdmin = async (req, res) => {
//   let event = { event_status: req.param('event_status'),
//   PSAP_center_id: req.param('PSAP_center_id'),
...
// adminController.updateDisappearedUserDetails = async (req, res) => {
//   try{
...
// adminController.selectUserForDisappearance = async (req, res) => {
//   let event = req.body;
//   try{
//     console.log("event",event);
//     let user = {
...
// adminController.sendMessageToUsersinVicinity = async (req, res) => {
//   let event = req.body;
//   try{
...
// adminController.cancelResearchForDisappearance = async (req, res) => {
//   let event = req.body;
//   try{
...
// adminController.userAcknowledgedForDisappearance = async (req, res) => {
//   let event = req.body;
...
// adminController.closeDisappearedEvent = async (req, res) => {
//   let event = req.body;
...
// adminController.changeVicinityArea = async (req, res) => {
//   let event = req.body;
...
// adminController.pauseOrResumeLocationUpdates = async (req, res) => {
//   let event = req.body;
...
// adminController.getSecuredURLToUploadAudio = async (req, res) => {
//   let event = req.body;
//   console.log(" inside event :" ,event);
//   try{
...
// adminController.getEventsBasedOnIds = async (req, res) => {
...
// adminController.getDisappearedUserRecordings = async (req, res) => {
//   let event = {
//      event_id: req.param("event_id"),
...
// adminController.getTwilioAccessTokenForVideoCall = async (req, res) => {
//   let event = req.body;
//   try{
...
// adminController.rejectVideoCall = async (req, res) => {
//   let event = req.body;
//   try{
...
// adminController.getAssignedPSAPCenterByEventId = async (req, res) => {
//   let event = {
//     event_id:req.param("event_id")
//   };
//   try{
...
// //We update the “event_status” to 172 and insert all the information related to the persons involved in event sent by the PSAP agent
// // And sends the real time message to all the Active FAUs.
// adminController.closeFreeUserEvent = async (req, res) => {
//   let event = req.body;
//   try{
//     console.log("closeEventByPSAP params :",event);
//     let authorization = req.headers['authorization'];
...
// //We update the “event_status” to 172 and insert all the information related to the persons involved in event sent by the PSAP agent
// // And sends the real time message to all the Active FAUs.
// adminController.cancelFAURecruitement = async (req, res) => {
//   let event = req.body;
//   try{
//     console.log("closeEventByPSAP params :",event);
//     let authorization = req.headers['authorization'];
...
//   });
// }
// adminController.closeFreeEventsWithBatch = async (req, res) => {
