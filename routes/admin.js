...
router.get('/getusers',verifyToken,async (req, res, next)=> {
    ...
    try {
    let body = req.query;
    console.log("getusers:body ",body)
    let users = await adminController.getusers(body)
  ...
  router.post('/addserviceboy',verifyToken,async (req, res, next)=> {

    try {
    let body = req.body;
    console.log("login:body ",body)
    let user = await adminController.addServiceBoy(body);
  ...
  router.get('/getpurchases',verifyToken,async (req, res, next)=> {
    ...
    let purchases = await adminController.getPurchases(body);
